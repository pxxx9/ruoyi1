package org.dromara.onlineCourse.controller;
...
import org.dromara.onlineCourse.domain.vo.OnlineCourseVo;
import org.dromara.onlineCourse.domain.bo.OnlineCourseBo;
import org.dromara.onlineCourse.service.IOnlineCourseService;
...
@RestController
@RequestMapping("/onlineCourse/onlineCourse")
public class OnlineCourseController extends BaseController {
     ...
     * 查询线上课程列表
     */
    @SaCheckPermission("onlineCourse:onlineCourse:list")
    @GetMapping("/list")
     ...
     * 导出线上课程列表
     */
    @SaCheckPermission("onlineCourse:onlineCourse:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("onlineCourse:onlineCourse:query")
    @GetMapping("/{id}")
     ...
     * 新增线上课程
     */
    @SaCheckPermission("onlineCourse:onlineCourse:add")
     ...
     * 修改线上课程
     */
    @SaCheckPermission("onlineCourse:onlineCourse:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("onlineCourse:onlineCourse:remove")
