package org.dromara.offlineCourse.controller;
...
import org.dromara.offlineCourse.domain.vo.OfflineCourseVo;
import org.dromara.offlineCourse.domain.bo.OfflineCourseBo;
import org.dromara.offlineCourse.service.IOfflineCourseService;
...
@RestController
@RequestMapping("/offlineCourse/offlineCourse")
public class OfflineCourseController extends BaseController {
     ...
     * 查询线下课程列表
     */
    @SaCheckPermission("offlineCourse:offlineCourse:list")
    @GetMapping("/list")
     ...
     * 导出线下课程列表
     */
    @SaCheckPermission("offlineCourse:offlineCourse:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("offlineCourse:offlineCourse:query")
    @GetMapping("/{id}")
     ...
     * 新增线下课程
     */
    @SaCheckPermission("offlineCourse:offlineCourse:add")
     ...
     * 修改线下课程
     */
    @SaCheckPermission("offlineCourse:offlineCourse:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("offlineCourse:offlineCourse:remove")
